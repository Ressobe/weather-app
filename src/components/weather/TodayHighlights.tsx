...
//       <Card>
//         <p className="text-slate-400 text-xl">Wind status</p>
...
//         <span className="text-slate-400 text-xl self-start">
//           Sunrise & Sunset
//         </span>
...
//           </svg>
//           {convertUnixTimeStamp(currentWeather.sunrise)}
//         </span>
//         <span className="text-xl flex justify-center items-center gap-5">
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
...
//           </svg>
//           {convertUnixTimeStamp(currentWeather.sunset)}
//         </span>
//       </div>
...
//       </div>
//       <div className="p-4 rounded-lg bg-white flex flex-col justify-between items-center">
//         <p className="text-slate-400 text-xl self-start">Air quality</p>
...
//           {pollutionScale[currentWeather.air_quality - 1]}
//         </p>
//       </div>
//     </div>
//   </div>
